...
public interface DispatchTaskEntityDao extends IDao<DispatchTaskEntity> {
    ...
    List<DispatchTaskEntity> selectWithLimit(@Param("handlerGroup") String handlerGroup, @Param("nodes") List<Integer> nodes, @Param("nowExecTs") Long nowExecTs, @Param("offset") Integer offset, @Param("limit") Integer limit);
